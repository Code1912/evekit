...
import {LoadingService, AlertService, AuthService, UserInfo} from "eve/services"
...
export class EveComponent implements OnInit ,AfterContentInit{
  ...
  //  @ViewChildren(TodoComponent) todoComponents: QueryList<TodoComponent>;
    constructor( private ele:ElementRef,private  loadingService:LoadingService,private alertService:AlertService,private  authService:AuthService) {
